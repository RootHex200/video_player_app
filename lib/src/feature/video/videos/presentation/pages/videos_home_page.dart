...
import 'package:video_player_flutter/src/feature/video/details/presentation/pages/video_details_page.dart';
              ...
              return videoList.isEmpty? const Center(
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return index<videoList.length? InkWell(
                        onTap: (){
                          Navigator.push(context, MaterialPageRoute(builder: (context)=>VideoDetailsPage(videos: videoList[index])));
                        },
                        child: Container(
